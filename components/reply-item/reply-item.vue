		...
		<view class="comment-hd flex-between">
			<view class="flex-start">
				<view class="tx" @click="tolink('/pages/homepage/homepage?id='+dataitem.MemberId)">
					<image :src="dataitem.MemberHead||'http://xcx.yixijiu19.com/static/default.png'" mode="aspectFill"></image>
				</view>
				<view class="info">
				...
				<view class="reply-hd flex-between" v-if="false">
					<view class="flex-start">
						<view class="tx" @click="tolink('/pages/homepage/homepage?id='+item.MemberId)">
							<image :src="item.MemberHead||'http://xcx.yixijiu19.com/static/default.png'" mode="aspectFill"></image>
						</view>
						<view class="info">
