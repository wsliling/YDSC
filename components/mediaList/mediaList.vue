		...
		<view class="media-list">
			...
			<view class="media-foot">
				...
				<view class="media-info-r">
					<text class="info-text"><text class="iconfont icon-liulan"></text>{{dataitem.BrowseNum}}</text>
					<text class="info-text"><text class="iconfont icon-pinglun1"></text>{{dataitem.CommentNum}}</text>
					<text class="info-text" @click.stop="like(dataitem.Id)"><text :class="['iconfont',dataitem.IsLike>0?'icon-zan1':'icon-zan']"></text>{{dataitem.LikeNum}}</text>
				</view>
			</view>
			</view>
		</view>
