...
export class show_model{
	constructor(option={}) {
		...
		let opacity = option.opacity || 0.3;
		...
		let confirmColor=option.confirmColor||'#ff3333';
	...
	creatView(style,opa,clickEvent,modelInfo){
		...
		view.draw([
		    ...
		    {tag:'font',id:'title',text:modelInfo.tit,textStyles:{size:'16px',color:'#000'},position:{top:this.pageHeight*0.43+'px',left:'20%',width:'60%',height:'4%'}},
		    {tag:'font',id:'text',text:modelInfo.content,textStyles:{size:'14px',color:'#666',whiteSpace:'normal',align:modelInfo.align},position:{top:this.pageHeight*0.44+'px',left:'22%',width:'56%',height:'10%'}},
