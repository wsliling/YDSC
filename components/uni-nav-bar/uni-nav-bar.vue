<template>
	<view class="uni-navbar">
		<view :class="{ 'uni-navbar--fixed': fixed, 'uni-navbar--shadow': shadow, 'uni-navbar--border': border, dis: leftIcon == 'arrowleft' }" class="uni-navbar__content">
			<!-- #ifdef APP-PLUS -->
 ...
 * @property {String} leftIcon 左侧按钮图标（图标类型参考 [Icon 图标](https://ext.dcloud.net.cn/plugin?id=28) type 属性）
 * @property {String} rightIcon 右侧按钮图标（图标类型参考 [Icon 图标](https://ext.dcloud.net.cn/plugin?id=28) type 属性）
...
/* #ifdef MP-WEIXIN */
.uni-navbar--fixed.dis .uni-navbar__header-btns-left {
	display: none !important;
}
.uni-navbar--fixed.dis .uni-navbar__header-container {
	margin-left: 30rpx;
}
/* #endif */
