...
//     payPassword;支付密码
// }
let apiwxurl="",apialiurl="";
if(params.attestType==1){
	apiwxurl='Order/SageAuthWechatPay';
	apialiurl='Order/SageAuthAliPay';
}else{
	apiwxurl='Order/ShopAuthWechatPay';
	apialiurl='Order/ShopAuthAliPay';
}
...
async function zfbH5pay(){
    let NewUrl=this.GetUrlRelativePath() +'/#/pages/other/attest/attest?type='+params.attestType;
