	...
	<div class="foot_list">
		<div class="or_item">
			<view class=" uni-mt10">
				<view class="product-comment bg_fff">
					<view class="pictrue">
						...
						<view>
							...
							<view class="price"><text class="c_theme fz12">￥</text>{{shopInfo.ActualPay}}</view>
						</view>
					</view>
					<view class="rate-item">
						<view class="title">描述相符</view>
						<uni-rate size="18" margin="10" color="#bbb" :starType="1" :showtxt="true" active-color="#ff0000" value="5"
						 @change="onChange"></uni-rate>
					</view>
					<view class="rate-item">
						<view class="title">物流服务</view>
						<uni-rate size="18" margin="10" color="#bbb" :starType="2" :showtxt="true" active-color="#ff0000" value="5"
						 @change="onChange"></uni-rate>
					</view>
					<view class="rate-item">
						<view class="title">服务态度</view>
						<uni-rate size="18" margin="10" color="#bbb" :starType="3" :showtxt="true" active-color="#ff0000" value="5"
						 @change="onChange"></uni-rate>
					</view>
				</view>
				<!--遇到的问题-->
				...
				<view class="counter bg_fff"><text class="num">{{inputTxtLength}}</text>/300</view>
		...
		<!-- 	<view class="uni-bg-white uni-mt10">
			...
			<view class="isIncognito" @click="getIncognito">
				<view :class="isIncognito==1?'active':''">
