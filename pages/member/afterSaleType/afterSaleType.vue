      ...
      <view class="pw3 mt2 bg_fff">
		  ...
		  @click="goUrl(1)">
              <view class="flex flexAlignCenter">
                  <image src="http://xcx.yixijiu19.com/static/icon_change.png" alt="" class="huan mr2"></image>
				  <view>
					   <view >申请换货</view>
		  ...
		  @click="goUrl(2)">
              <view class="flex flexAlignCenter">
                  <image src="http://xcx.yixijiu19.com/static/icon_return.png" alt="" class="huan mr2"></image>
				  <view>
					   <view >申请退货退款</view>
					   <view style="font-size: 24upx;" class="color_gray">已收到货，需要更换已收到的货物</view>
				  </view>
		  ...
		  @click="goUrl(3)">
              <view class="flex flexAlignCenter">
                  <image src="http://xcx.yixijiu19.com/static/icon_refund.png" alt="" class="huan mr2"></image>
				  <view>
					   <view>仅退款（无需退货）</view>
