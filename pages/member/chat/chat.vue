	...
	<view>
		<scroll-view scroll-y :scroll-top="scrolltop" scroll-with-animation="true" class="cu-chat">
			...
			<!-- <view class="cu-item self">
				<view class="main">
					<!-1- #ifdef MP-WEIXIN --1>
					<image src="http://m.dance-one.comhttp://xcx.yixijiu19.com/static/of/banner.jpg" mode="widthFix"></image>
					<!-1- #endif -->
					<!-- #ifndef MP-WEIXIN --1>
					<img src="http://m.dance-one.comhttp://xcx.yixijiu19.com/static/of/banner.jpg" class="img">
					<!-1- #endif --1>
				</view>
				<view class="cu-avatar" style="background-image:url(http://m.dance-one.comhttp://xcx.yixijiu19.com/static/default.png);"></view>
			</view>
			<view class="cu-item">
				<view class="cu-avatar" style="background-image:url(http://m.dance-one.comhttp://xcx.yixijiu19.com/static/of/2.png);"></view>
				<view class="main">
					<!-1- #ifdef MP-WEIXIN --1>
					<image src="http://m.dance-one.comhttp://xcx.yixijiu19.com/static/of/3.png" mode="widthFix"></image>
					<!-1- #endif -1->
					<!-1- #ifndef MP-WEIXIN -1->
					<img src="http://m.dance-one.comhttp://xcx.yixijiu19.com/static/of/3.png" class="img">
					<!-1- #endif --1>
				</view>
			</view> -->
		</scroll-view>
		...
		<view class="foot-fiexd">
			...
			<view :class="['foot-reply flex',IsShowReplyBox?'active':'']">
				<input class="ipt flex1" type="text" v-model="Comment" cursor-spacing="10" @click="showReplyBox" 
					placeholder="请输入" confirm-type="send" @confirm="send"
					/>
				<view class="btn-r" v-if="IsShowReplyBox">
					<view :class="['sendBtn',Comment==''?'dis':'']" @click="send">发送</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			async openSocket(){
				const res = await post('TencentCloud/GetWebSocketId',{
					UserId: this.userId,
					Token: this.token,
					ToMemberId:this.id
				})
