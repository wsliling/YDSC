...
<style scoped lang="scss">
  ...
  .for_hd .icon_l {
      background: url(https://yd.wtanvxin.com/static/tit_l.png) center center no-repeat;
      background-size: cover;
  }
  .for_hd .icon_r {
      background: url(https://yd.wtanvxin.com/static/tit_r.png) center center no-repeat;
      background-size: cover;
  }
</style>
