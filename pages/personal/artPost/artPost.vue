<template>
	<view class="content">
		...
		<!-- <view class="advbox" v-if="showmsk==1">
			<view class="imgbox">
				<view class="textbox">
					<view class="title">英达思创平台服务协议（EULA）</view>
					<view class="main">
						<p>用户在接受英达思创平台服务之前，请务必仔细阅读本条款并同意本声明。</p>
						<p>第一条</p>
						...
						　　<p>3. 不得干扰、损害和侵犯英达思创的各种合法权利与利益;</p>
						
						　　<p>4. 遵守壹舞平台以及与之相关的网络服务的协议、指导原则、管理细则等;</p>
						
						　　<p>5.英达思创有权对违反上述承诺的内容予以删除。</p>
						
						<p>第二条</p>
						
						　　<p>1. 用户在英达思创发表的内容(包含但不限于英达思创目前各产品功能里的内容)仅表明其个人的立场和观点，并不代表英达思创的立场或观点。作为内容的发表者，需自行对所发表内容负责，因所发表内容引发的一切纠纷，由该内容的发表者承担全部法律及连带责任。英达思创不承担任何法律及连带责任。</p>
						
						　　<p>2. 用户在英达思创发布侵犯他人知识产权或其他合法权益的内容，英达思创有权予以删除，并保留移交司法机关处理的权利。</p>
						
						　　<p>3. 个人或单位如认为英达思创上存在侵犯自身合法权益的内容，应准备好具有法律效应的证明材料，及时与英达思创取得联系，以便英达思创迅速做出处理。</p>
						
						　　附则：对免责声明的解释、修改及更新权均属于英达思创所有。
					</view>
