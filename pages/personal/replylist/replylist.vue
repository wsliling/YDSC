			...
			<view class="media-list">
				...
				<view class="media-hd flex-between">
					<view class="media-author" @click="gotoPensonal">
						<image class="img" :src="NewsInfo.Avatar||'https://yd.wtanvxin.com/static/default.png'" mode="aspectFill"></image>
					</view>
			...
			<view class="bd flex-between">
				<view class="imgs flex1" v-if="!nolike">
					<block v-for="(item,index) in LikesList" :key="index">
						<image class="tx" :src="item.Avatar||'https://yd.wtanvxin.com/static/default.png'" mode="aspectFill"></image>
					</block>
				</view>
