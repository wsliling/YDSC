			...
			<view class="pay-bd line-list">
				<block v-for="(item, index) in payway" :key="index">
					<view class="line-item flex-between" @click="tabBtn(item.type)">
						...
						<view class="item-r"><view style="margin: 0;" :class="['IconsCK IconsCK-radio', payType == index ? 'checked' : '']"></view></view>
					</view>
				</block>
			</view>
		</view>
		<view class="present"><view class="recharge" @click="Submit">确认充值</view></view>
		<!-- 支付宝H5表单 -->
