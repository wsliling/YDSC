<template>
	<view class="course">
		...
		<view class="sec">
			<view><image src="../../../static/health/change/class_2.png"></image></view>
			<view>
				<image src="../../../static/health/change/class_3.png"></image>
				<image src="../../../static/health/change/class_4.png"></image>
			</view>
		</view>
		...
		<view class="sec1">
			...
			<view class="sec1_2">
				<image src="../../../static/health/change/class_6.png"></image>
