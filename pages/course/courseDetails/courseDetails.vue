<template>
	<view class="courseDetails">
		<view class="top">
			...
			<view class="info1">
				<view class="info1_3"><image :src="appcoursedetail.CoachAvatar || '/static/default.png'"></image></view>
		...
		<view class="cen">
			<view class="stadium"><image :src="appcoursedetail.StoreLogo || '/static/default.png'"></image></view>
