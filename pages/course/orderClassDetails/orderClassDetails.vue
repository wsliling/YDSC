<template>
	<view class="orderClassDetails">
		<view class="top">
			...
			<view class="info1">
				<view class="info1_3"><image :src="orderdetail.CoachAvatar || 'https://yd.wtanvxin.com/static/default.png'" mode="aspectFill"></image></view>
		...
		<view class="cen">
			<view class="stadium"><image :src="orderdetail.StoreLogo || 'https://yd.wtanvxin.com/static/default.png'" mode="aspectFill"></image></view>
